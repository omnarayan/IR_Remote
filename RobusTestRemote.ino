...
void setup(void) {
      ...
      if (configFile) {
        ...
        if (size > 0) {
          ...
          if ( ! deserializeError ) {
            ...
            nerveURL =  "https://" + String(host1) + ":" + String(port1) + "/neuron/v3/node?nodeType=smartSwitchNode&licensekey=" + String(license1) + "&machineID=" + WiFi.macAddress() + "&name=" + WiFi.macAddress() + "&relay=" + String(digitalRead(Relay_01));
  ...
  //  nerveURL =  "https://" + String(nerveServerHost) + ":" + String(nerveServerPort) + "/neuron/v3/node?nodeType=smartSwitchNode&licensekey=" + String(licenseKey) + "&machineID=" + WiFi.macAddress() + "&name=" + WiFi.macAddress() + "&relay=" + String(digitalRead(Relay_01));
...
void saveParamCallback() {
  ...
  nerveURL =  "https://" + getParam("nerveServerHost") + ":" + getParam("nerveServerPort") + "/neuron/v3/node?nodeType=smartSwitchNode&licensekey=" + getParam("licenseKey") + "&machineID=" + WiFi.macAddress() + "&name=" + WiFi.macAddress() + "&relay=" + String(digitalRead(Relay_01));
